...
export function MembersPanel({ members = [], currency = 'MXN' }) {
    ...
    return (
        <section className="card" aria-label="Integrantes del hogar">
            <div className="listHeader">
                <h2 className="sectionTitle">
                    <span className="sectionTitleIcon" aria-hidden>MB</span>
                    Integrantes
                </h2>
                        ...
                        <div key={member.id} className="memberRow">
                            ...
                            <div className="memberStats">
                                {salaryCents > 0 ? (
                                    ...
                                    <span className="memberNoSalary">sin sueldo</span>
                                )}
                            </div>
                        </div>
                    )
