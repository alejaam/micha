    ...
    return (
        <section className="card onboardingCard" aria-label="Set up your cards">
            <div className="onboardingHeader">
                <p className="authEyebrow">Step 2</p>
                <h2 className="authTitle">Add your cards</h2>
                <p className="authMeta">This step is optional. Add cards now or continue and configure them later.</p>
            </div>
            ...
            <div className="flex gap-4 mt-4">
                <button type="button" className="btn flex-1" onClick={handleContinue}>
                    Skip cards for now
                </button>
                <button type="button" className="btn btnPrimary flex-1" onClick={handleContinue}>
                    Continue to fixed expenses
                </button>
            </div>
            {!hasCards && (
                <p className="formHint mt-4">
                    No cards yet. You can add them later from dashboard settings.
                </p>
            )}
        </section>
    )
